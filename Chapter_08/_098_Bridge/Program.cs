namespace _098_Bridge
{
    ...
    public abstract class Orchard
    {
        ...
        public Fruit Fruit { set { fruit = value; } }  //将具体的水果类实例赋值给抽象水果类引用
        public abstract void Plant();               //抽象种植方法
    }
    //北京果园
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            bjOrchard.Fruit = new Orange();                 //创建橘子类实例
            bjOrchard.Plant();                              //北京果园种植橘子
            Orchard shOrchard = new SHOrchard();            //创建上海果园实例
            shOrchard.Fruit = new Apple();                  //创建苹果类实例
            shOrchard.Plant();                              //上海果园种植苹果
            shOrchard.Fruit = new Orange();                 //创建橘子类实例
            shOrchard.Plant();                              //上海果园种植橘子
        }
    }
}
